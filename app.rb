...
happy_thoughts.add_smile("redbull :D")
happy_thoughts.add_smile("life is good")
happy_thoughts.add_smile('happy happy joy joy')
happy_thoughts.add_smile('log log its big better its wood')
happy_thoughts.add_smile('log log better than bad its good')
